...
public class DateFormatUtils {
    ...
    public static Date parseDate(String dateStr) throws ParseException {
        return parseDate(dateStr,FormatEnums.yyyy_MM_dd_HH_mm_ss);
    }

    public static Date parseDate(String dateStr,FormatEnums formatEnums) throws ParseException {
        SimpleDateFormat format = new SimpleDateFormat(formatEnums.getValue());
